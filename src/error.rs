...
//!
//! Educational Notes:
//! - Use thiserror to simplify error enum definition
//! - All errors converge to DaoQLError, avoiding raw Box<dyn Error>
//! - Error messages use English for teaching clarity
